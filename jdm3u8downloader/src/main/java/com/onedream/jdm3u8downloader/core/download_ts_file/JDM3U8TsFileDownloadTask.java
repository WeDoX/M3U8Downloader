package com.onedream.jdm3u8downloader.core.download_ts_file;
...
public class JDM3U8TsFileDownloadTask extends AsyncTask<Integer, Integer, Integer> {
    ...
    public List<JDM3U8TsDownloadUrlBean> m3U8TsBeanList;
    public @Nullable
    ...
    protected Integer doInBackground(Integer... params) {
        ...
        for (JDM3U8TsDownloadUrlBean m3U8TsBean : m3U8TsBeanList) {
    ...
    private int downLoadTsFile(JDM3U8TsDownloadUrlBean m3U8TsBean) {
    ...
    private long getTsFileSize(JDM3U8TsDownloadUrlBean m3U8TsBean) {
