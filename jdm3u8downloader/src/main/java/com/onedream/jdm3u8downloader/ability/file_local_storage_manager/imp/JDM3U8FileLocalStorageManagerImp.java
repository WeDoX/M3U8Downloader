package com.onedream.jdm3u8downloader.ability.file_local_storage_manager.imp;
...
public class JDM3U8FileLocalStorageManagerImp implements JDM3U8FileLocalStorageManager {
    ...
    @Nullable
    @Override
    public File getTsFile(JDDownloadQueue downloadQueue, JDM3U8TsDownloadUrlBean m3U8TsBean) {
    ...
    @Nullable
    @Override
    public File getTsFileAndIsEmptyNeedCreate(JDDownloadQueue downloadQueue, JDM3U8TsDownloadUrlBean m3U8TsBean) {
