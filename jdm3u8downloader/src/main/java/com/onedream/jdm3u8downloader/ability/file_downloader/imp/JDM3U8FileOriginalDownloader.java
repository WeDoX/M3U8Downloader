package com.onedream.jdm3u8downloader.ability.file_downloader.imp;
...
public class JDM3U8FileOriginalDownloader extends JDM3U8FileAbstractDownloader {
    ...
    @Override
    public int downLoadTsFile(final JDM3U8TsDownloadUrlBean m3U8TsBean, final File tempSaveFile) {
